...
var _init = {
	...
	app: function() {
		...
		_views[viewLabel].headerbar.setTitleImage("assets/img/logo.jpg", 0);
		...
		_views[viewLabel] = new FM_View();
		_views[viewLabel].create(viewLabel, viewLabel);
		_views[viewLabel].loadModelsArticle(["note"]);
		_views[viewLabel].headerCreate();
		//_views[viewLabel].headerbar.addButton("button-notes-left", "", "logout", "_navigator.home.page2()", "left", null, 0);
		//_views[viewLabel].headerbar.addButton("button-notes-right", "", "warning", "_navigator.home.page3()", "right", null, 0);
		_views[viewLabel].headerbar.setTitleImage("assets/img/logo.jpg", 0);
		_views[viewLabel].headerbar.setTitle(_system.label("notes"), 0);
